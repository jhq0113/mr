...
class Redis
{
    ...
    private function redirect($redirect, $command, $params)
    {
        ...
        throw new SocketException('No hostname found in redis redirect (MOVED): ' . VarDumper::dumpAsString($redirect));
    }
